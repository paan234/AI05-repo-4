# -*- coding: utf-8 -*-
"""
Created on Tue Apr 19 14:23:08 2022
...
#1. Data loading
train_file_dir = r'C:\Users\ACER\Desktop\SHRDC\Git\AI-05 repo 4\data-science-bowl-2018\Dataset\train'
test_file_dir = r'C:\Users\ACER\Desktop\SHRDC\Git\AI-05 repo 4\data-science-bowl-2018\Dataset\test'
...
train_masks_np = np.array(test_masks)
...
test.batch(BATCH_SIZE).prefetch(buffer_size=AUTOTUNE)
...
#Define the model
OUTPUT_CLASSES = 2
model = unet_model(outut_channels = OUTPUT_CLASSES)
...
#%%
#Create a functionto display some examples
...
base_log_path = r"C:\Users\ACER\Desktop\SHRDC\Deep learning\TensorBoard\p4_log"
